...
export const translations = {
  vi: {
    ...
    ocr_btn_translate_image: "Dịch",
    ocr_btn_scan_image_title: "Quét chữ & dịch nghĩa",
    ocr_tab_ocr: "OCR & Tra từ",
    ocr_tab_translate: "Dịch nghĩa",
    ocr_orient_auto: "Tự động",
    ocr_orient_horizontal: "Chữ ngang (jpn)",
    ocr_orient_vertical: "Chữ dọc (jpn_vert)",
    ocr_orient_tooltip: "Hướng chữ tiếng Nhật",
    ocr_original_label: "Văn bản gốc (Nhấp vào từ để tra)",
    ocr_edit_mode: "Sửa chữ",
    ocr_edit_cancel: "Hủy sửa",
    ocr_reanalyze: "Phân tích lại",
    ocr_edit_placeholder: "Chỉnh sửa ký tự OCR tại đây...",
    ocr_translation_label: "BẢN DỊCH TIẾNG VIỆT",
    ocr_translation_empty: "Chưa có bản dịch cho câu này.",
    ocr_original_sentence: "Câu gốc",
    ocr_copy: "Sao chép",
    ocr_copy_short: "Chép",
    ocr_copied: "Đã chép",
    ocr_close: "Đóng",
    ocr_scanning: "Đang nhận diện ký tự...",
    ocr_translating: "Đang tạo bản dịch...",
    ocr_timeout: "Quét chữ OCR hết thời gian chờ, vui lòng thử lại.",
    ocr_no_text_image: "Không tìm thấy văn bản tiếng Nhật trong ảnh này.",
    ocr_no_text_crop: "Không tìm thấy chữ trong vùng chọn",
    ocr_coming_soon: "Tính năng OCR đang được phát triển và sẽ ra mắt trong phiên bản sắp tới!",
  },
  ...
  en: {
    ...
    // OCR & Image Scanning
    ocr_title: "Hakkutsu OCR",
    ocr_btn_translate_image: "Translate",
    ocr_btn_scan_image_title: "Scan text & translate",
    ocr_tab_ocr: "OCR & Lookup",
    ocr_tab_translate: "Translation",
    ocr_orient_auto: "Auto",
    ocr_orient_horizontal: "Horizontal (jpn)",
    ocr_orient_vertical: "Vertical (jpn_vert)",
    ocr_orient_tooltip: "Japanese Text Orientation",
    ocr_original_label: "Original Text (Click word to lookup)",
    ocr_edit_mode: "Edit text",
    ocr_edit_cancel: "Cancel edit",
    ocr_reanalyze: "Re-analyze",
    ocr_edit_placeholder: "Edit OCR text here...",
    ocr_translation_label: "ENGLISH TRANSLATION",
    ocr_translation_empty: "No translation available for this sentence.",
    ocr_original_sentence: "Original Sentence",
    ocr_copy: "Copy",
    ocr_copy_short: "Copy",
    ocr_copied: "Copied",
    ocr_close: "Close",
    ocr_scanning: "Recognizing characters...",
    ocr_translating: "Generating translation...",
    ocr_timeout: "OCR timed out, please try again.",
    ocr_no_text_image: "No Japanese text found in this image.",
    ocr_no_text_crop: "No text found in selected region",
    ocr_coming_soon: "OCR feature is coming soon in a future update!",
  },
};
