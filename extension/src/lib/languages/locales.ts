...
export const translations = {
  vi: {
    ...
    sub_modal_title: "Chọn phụ đề (Select Subtitles)",
    ...
    sub_modal_track_primary: "Phụ đề chính (Subtitle Track 1)",
    sub_modal_track_secondary: "Phụ đề phụ (Subtitle Track 2 - Tùy chọn)",
    sub_modal_empty: "Trống (Empty)",
  ...
  en: {
    ...
    sub_modal_info: "Auto-detected subtitle tracks can be selected here. You can also load your own subtitle files or search Jimaku.cc.",
    sub_modal_video_name: "Video Name",
    sub_modal_track_primary: "Subtitle Track 1",
    sub_modal_track_secondary: "Subtitle Track 2 (Optional)",
    sub_modal_empty: "Empty",
    sub_modal_open_files: "Open subtitle files (.srt, .vtt, .ass)...",
    sub_modal_search_online: "Search Online Subtitles (Jimaku.cc)...",
    sub_modal_btn_open_files: "OPEN FILES",
    sub_modal_btn_search_online: "SEARCH ONLINE SUBTITLES",
    sub_modal_remember: "Remember these track choices for this site",
