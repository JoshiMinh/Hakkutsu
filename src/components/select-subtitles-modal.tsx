...
import { X, FolderOpen, Check, ChevronDown, Clock, Type, Subtitles } from "lucide-react";
        ...
        >
          ...
          {allowAutoTranslate && (
            <button
              type="button"
              role="option"
              aria-selected={value === "__auto_translate__"}
              onClick={() => {
  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="hakkutsu-subtitle-modal-title"
        tabIndex={-1}
        style={{
          width: "100%",
          maxWidth: "480px",
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              <h2 id="hakkutsu-subtitle-modal-title" style={{ margin: 0, fontSize: "15px", fontWeight: 700, color: "#fff" }}>
        ...
        <div style={{ padding: "20px", overflowY: "auto", flex: 1, display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div
            role="button"
            tabIndex={0}
            aria-label="Load a custom subtitle file"
            onDragOver={(e) => {
              e.preventDefault();
              e.stopPropagation();
              setIsDragOver(true);
