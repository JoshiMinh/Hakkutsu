...
const HANVIET_MAP: Record<string, string> = {
  ...
  "使": "SỬ", "用": "DỤNG", "害": "HẠI", "助": "TRỢ", "想": "TƯởNG",
  "谷": "CỐC", "離": "LY", "未": "VỊ", "婚": "HÔN",
  "率": "SUẤT", "昇": "THĂNG", "推": "THÔI", "協": "HIỆP",
  "団": "ĐOÀN", "独": "ĐỘC", "決": "QUYẾT", "求": "CẦU",
  "性": "TÍNH", "原": "NGUYÊN", "因": "NHÂN"
};
