...
export const vi = {
  ...
  drawer_title: "Kịch bản phụ đề",
  drawer_subtitle: "Chế độ đọc & Tìm kiếm hội thoại",
  drawer_search_placeholder: "Tìm kiếm lời thoại tiếng Nhật hoặc bản dịch...",
  drawer_matches_count: "kết quả",
  drawer_no_matches: "Không tìm thấy lời thoại phù hợp",
  drawer_stats_lines: "câu thoại",
  drawer_stats_chars: "ký tự",
  drawer_stats_known: "Đã học",
  drawer_stats_unlearned: "Từ mới",
  drawer_btn_resume_sync: "Tiếp tục tự cuộn",
  drawer_btn_mine_srs: "Lưu vào SRS",
  drawer_btn_mined: "Đã lưu",
  drawer_btn_copy: "Sao chép câu thoại",
  drawer_btn_play: "Phát câu này",
  drawer_btn_tts: "Nghe phát âm",
  drawer_filter_all: "Tất cả câu",
  drawer_filter_matched: "Chỉ câu khớp",
  drawer_btn_toggle_drawer: "Mở kịch bản (T)",
  drawer_empty_no_cues: "Chưa có kịch bản phụ đề cho video này.",
  drawer_toggle_translation: "Bật/tắt bản dịch",
  drawer_toggle_furigana: "Bật/tắt Furigana",
