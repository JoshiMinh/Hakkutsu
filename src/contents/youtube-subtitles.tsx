  ...
  useEffect(() => {
        ...
        <div style="padding: 10px 14px 12px; display: flex; flex-direction: column; gap: 8px; font-size: 12px;">
          ...
          <div style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <div style="display: flex; align-items: center; gap: 6px;">
              <button data-hk-action="toggle-drawer" style="font-size: 10px; font-weight: 700; padding: 2px 6px; border-radius: 4px; background: rgba(168,85,247,0.2); border: 1px solid rgba(168,85,247,0.3); color: #c084fc; cursor: pointer;">
                ${t("btn_open")}
              </button>
              <kbd style="padding: 2px 6px; border-radius: 4px; background: rgba(255,255,255,0.15); color: #fff; font-family: monospace; font-size: 11px; font-weight: 700;">T</kbd>
            </div>
          </div>
    ...
    const showHoverMenu = (btnEl: HTMLElement) => {
      ...
      if (!hoverMenu || !hoverMenu.parentElement) {
        ...
        // Delegate buttons click — survives innerHTML re-renders
        hoverMenu.addEventListener("click", (ev) => {
          ...
          if (target.closest("[data-hk-action='open-modal']")) {
            ...
            setIsModalOpen(true);
          } else if (target.closest("[data-hk-action='toggle-drawer']")) {
            ev.stopPropagation();
            hideHoverMenuImmediate();
            setIsEnabled(true);
            updateSettings({ subtitlesEnabled: true });
