<div align="center">
  <img src="icon.png" alt="Hakkutsu Logo" width="128" height="128" style="border-radius: 16px;" />
...
1. Download the production extension build package `chrome-mv3-prod.zip` from `extension/build/`.
2. Open your browser and navigate to `chrome://extensions`.
3. Enable **Developer mode** using the toggle switch in the upper right corner.
4. Drag and drop the `chrome-mv3-prod.zip` file onto the extensions page (*"Drop a ZIP or CRX file here or select a file"*), or click **Load unpacked** and choose `extension/build/chrome-mv3-prod`.
