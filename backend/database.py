...
def init_database() -> None:
    ...
    CREATE TABLE IF NOT EXISTS pages (
        ...
        outside_text_policy TEXT NOT NULL DEFAULT 'auto',
    ...
    CREATE TABLE IF NOT EXISTS text_blocks (
        ...
        ocr_confidence REAL,
        ocr_provider TEXT,
        text_kind TEXT NOT NULL DEFAULT 'dialogue',
        ...
        style_preset TEXT NOT NULL DEFAULT 'dialogue',
        policy_source TEXT NOT NULL DEFAULT 'auto',
        sfx_score REAL NOT NULL DEFAULT 0,
        mask_strategy TEXT NOT NULL DEFAULT 'auto',
        visual_confidence REAL,
        visual_model TEXT,
        visual_suggestion_json TEXT NOT NULL DEFAULT '{}',
    ...
    CREATE TABLE IF NOT EXISTS media_sources (
        ...
        source_type TEXT NOT NULL DEFAULT 'manual'
            CHECK (source_type IN ('youtube', 'netflix', 'subtitle_file', 'manual')),
        external_id TEXT,
        title TEXT NOT NULL DEFAULT '',
    ...
    CREATE TABLE IF NOT EXISTS media_segments (
        ...
        created_at TEXT NOT NULL,
        updated_at TEXT NOT NULL,
        UNIQUE(media_source_id, position),
    ...
    with db_session() as connection:
        ...
        _ensure_column(connection, "text_blocks", "text_kind", "TEXT NOT NULL DEFAULT 'dialogue'")
        _ensure_column(connection, "text_blocks", "content_type", "TEXT NOT NULL DEFAULT 'dialogue'")
        _ensure_column(connection, "text_blocks", "translation_mode", "TEXT NOT NULL DEFAULT 'translate'")
        _ensure_column(connection, "text_blocks", "render_mode", "TEXT NOT NULL DEFAULT 'replace'")
        _ensure_column(connection, "text_blocks", "style_preset", "TEXT NOT NULL DEFAULT 'dialogue'")
        _ensure_column(connection, "text_blocks", "policy_source", "TEXT NOT NULL DEFAULT 'auto'")
        _ensure_column(connection, "text_blocks", "sfx_score", "REAL NOT NULL DEFAULT 0")
        _ensure_column(connection, "text_blocks", "mask_strategy", "TEXT NOT NULL DEFAULT 'auto'")
        _ensure_column(connection, "text_blocks", "visual_confidence", "REAL")
        _ensure_column(connection, "text_blocks", "visual_model", "TEXT")
        _ensure_column(connection, "text_blocks", "visual_suggestion_json", "TEXT NOT NULL DEFAULT '{}'")
        _ensure_column(connection, "text_blocks", "policy_reasons_json", "TEXT NOT NULL DEFAULT '[]'")
        ...
        _ensure_column(connection, "pages", "editorial_decision", "TEXT NOT NULL DEFAULT 'auto'")
        _ensure_column(connection, "pages", "editorial_note", "TEXT NOT NULL DEFAULT ''")
        _ensure_column(connection, "pages", "editorial_decision_at", "TEXT")
        _ensure_column(connection, "pages", "outside_text_policy", "TEXT NOT NULL DEFAULT 'auto'")
        _ensure_column(connection, "pages", "visual_analysis_json", "TEXT NOT NULL DEFAULT '{}'")
        _ensure_column(connection, "pages", "visual_analysis_at", "TEXT")
        ...
        _ensure_column(connection, "vocabulary", "source_kind", "TEXT NOT NULL DEFAULT 'manga'")
        _ensure_column(connection, "vocabulary", "source_url", "TEXT NOT NULL DEFAULT ''")
        _ensure_column(connection, "vocabulary", "source_time", "REAL")
        # Backfill blocks created before content type/style were independent.
        connection.execute(
            """UPDATE text_blocks
               SET content_type = 'sfx', style_preset = 'action'
               WHERE text_kind = 'sfx' AND content_type = 'dialogue'
                 AND style_preset = 'dialogue'"""
        )
        connection.execute(
        ...
        connection.execute(
            "CREATE INDEX IF NOT EXISTS idx_media_segments_source ON media_segments(media_source_id, position)"
        )
        connection.execute(
